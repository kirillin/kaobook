...
% Choose the language
\usepackage[english, russian]{babel} % Load characters and hyphenation
\usepackage[english=british]{csquotes}	% English quotes

% russian specific font fot text and math
%\usepackage{XCharter}
...
\title[Очень хороший шаблон из {\normalfont\texttt{kaobook}} Class]{Очень хороший шаблон из {\normalfont\texttt{kaobook}} Class}
% \subtitle{Subtitle}
